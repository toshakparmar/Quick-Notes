  ...
  try {
    ...
    if (
      ...
      return {
        ...
        type: "information",
        message:
          "I'm a bit busy at the moment, but I'd be happy to help you with your notes! Would you like to:\n\n1. View your notes\n2. Create a new note\n3. Search existing notes",
        isInformation: true,
        requiresInput: true,
      };
    }
    ...
    if (error.message.includes("GoogleGenerativeAI Error")) {
      return {
        ...
        type: "information",
        message:
          "I'm having a brief connection issue. While I'm reconnecting, I can still help you manage your notes! What would you like to do?",
        isInformation: true,
        requiresInput: true,
      };
    }
    ...
    return {
      success: false,
      message:
        "I'm having a moment. How about we work with your notes instead?",
      type: "information",
      isInformation: true,
      requiresInput: true,
    };
...
app.post("/quick-notes/assistant", async (req, res) => {
  try {
    ...
    const result = await quickNotesAssistant(query);
    ...
    if (
      ...
      return res.json({
        success: true,
        message:
          "I'm a bit busy at the moment. Let me share what I know about that topic...",
        type: "information",
        isInformation: true,
        requiresInput: true,
      });
    ...
    if (err.message.includes("GoogleGenerativeAI Error")) {
      return res.json({
        ...
        type: "information",
        message:
          "I'm experiencing a brief connection issue. In the meantime, I can help you with your notes! Would you like to:\n\n1. View your existing notes\n2. Create a new note\n3. Search your notes",
        isInformation: true,
        requiresInput: true,
      });
    }
